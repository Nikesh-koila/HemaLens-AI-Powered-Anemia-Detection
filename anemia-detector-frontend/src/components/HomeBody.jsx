      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <h1 className="text-4xl md:text-6xl font-bold  mb-6 text-balance">
            Detect Anemia with Your
            <span className="text-[#079eff]"> Palm</span>
          </h1>
          <p className="text-xl text-gray-600 mb-8 text-pretty max-w-2xl mx-auto">
            AI technology analyzes your palm to detect signs of anemia in
            seconds. Quick, non-invasive, and accessible healthcare screening.
          </p>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Our AI analyzes the color and patterns in your palm to detect
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Use your camera or upload an existing photo of your palm in
                    good lighting.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    See your easy-to-understand screening result immediately
            ...
            <div className="bg-[#f1faff]  rounded-2xl p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">
                Position your palm clearly in the camera frame for best results
              </p>
              <Link href="/scan">
                <Button className="w-full bg-[#079eff] hover:bg-[#0384d4] cursor-pointer">
      ...
      <section className="py-16 px-4 bg-[#f7fcff]">
        <div className="container mx-auto text-center max-w-2xl">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Take the first step towards better health monitoring with our
